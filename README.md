# [full stack nginx Yii for everyone with docker compose](https://github.com/damalis/full-stack-nginx-yiiframework-for-everyone-with-docker-compose)

If You want to have a Yii "basic" website at short time; 

#### Full stack Nginx Yii "basic":
