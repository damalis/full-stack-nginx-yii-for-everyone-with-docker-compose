...
echo "============================================================================"
echo "|                                                                          |"
echo "|     full-stack-nginx-yiiframework-for-everyone-with-docker-compose       |"
echo "|                           by Erdal ALTIN                                 |"
echo "|                                                                          |"
echo "============================================================================"
sleep 2
...
if [ -x "$(command -v docker)" ] && [ -x "$(command -v docker-compose)" ]; then
	...
	# installing yiiframework and the other services
	docker-compose up -d & export pid=$!
	echo "yiiframework and the other services installing proceeding..."
	echo ""
	wait $pid
	if [ $? -eq 0 ]
	then
		...
		echo ""
		echo "Error! could not installed yiiframework and the other services with docker-compose" >&2
		exit 1
	fi
else
	echo ""
